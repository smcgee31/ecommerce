...
Once you've finished the front-end, take some time to style your app and make it user-friendly.  Tomorrow you will finish the app by adding a cart to the user, allow them to check out, and keep track of their current and past orders.
